...
class PropertyDerivations
{
            ...
            extends PlanVisitor<List<ActualProperties>, ActualProperties>
    {
        ...
        @Override
        public ActualProperties visitExpand(ExpandNode node, List<ActualProperties> inputProperties)
        {
            return Iterables.getOnlyElement(node.getSources()).accept(this, inputProperties);
        }
