    ...
    implements Matcher
{
    ...
    public boolean matches(PlanNode node, Session session, Metadata metadata, ExpressionAliases expressionAliases)
    {
        ...
        Map<Symbol, Symbol> actualIdentityMappings = groudIdNode.getIdentityMappings();
        ...
        if (!AggregationMatcher.matches(identityMappings.keySet(), actualIdentityMappings.keySet())) {
            return false;
        }
