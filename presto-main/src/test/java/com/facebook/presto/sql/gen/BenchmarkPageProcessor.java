...
public class BenchmarkPageProcessor
{
    ...
    public void setup()
    {
        ...
        compiledProcessor = new ExpressionCompiler(MetadataManager.createTestMetadataManager()).compilePageProcessor(FILTER, ImmutableList.of(ImmutableList.of(PROJECT))).get();
    }
